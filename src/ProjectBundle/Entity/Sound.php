...
class Sound
{
     ...
     * Add trash
     *
     * @param \ProjectUserBundle\Entity\User $trash
     *
     * @return Sound
     */
    public function addTrash(\ProjectUserBundle\Entity\User $trash)
    {
        $this->trashs[] = $trash;
     ...
     * @param \ProjectUserBundle\Entity\User $trash
     */
    public function removeTrash(\ProjectUserBundle\Entity\User $trash)
    {
